...
@section('content')
    ...
    <div class="col-sm-9 no-padding">
        ...
        <div class="col-sm-8 col-sm-offset-2 section-register-representante">
            <form action="/register-representante" method="POST">
                <input type="hidden" name="_token" value="{{ csrf_token() }}">
                <div class="form-group col-md-6 height-input{{ $errors->register->has('cedula') ? ' has-error' : '' }}">
                    <label>Cedula</label>
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('primer_nombre') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('segundo_nombre') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('primer_apellido') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('segundo_apellido') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('fecha_nacimiento') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('telefono') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('direccion') ? ' has-error' : '' }}">
                ...
                <div class="form-group col-md-6 height-input{{ $errors->register->has('sueldo_mensual') ? ' has-error' : '' }}">
